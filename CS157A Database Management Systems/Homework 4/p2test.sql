...
-- Insufficient funds in source_account
CALL p2.ACCT_TRX(1000, 1002, 200, ?,?);
SELECT NUMBER, BALANCE FROM p2.account where NUMBER IN(1000, 1002, 1003, 1005);

-- destination_account is invalid, source_account balance should stay the same
CALL p2.ACCT_TRX(1000, 100, 99, ?,?);
SELECT NUMBER, BALANCE FROM p2.account where NUMBER IN(1000, 1002, 1003, 1005);
