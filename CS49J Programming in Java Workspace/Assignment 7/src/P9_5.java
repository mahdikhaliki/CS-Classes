...
public class P9_5 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        save(apts, output_file);
        output_file.close();
    }

    public static void load(ArrayList<Appointment> apts, Scanner input_file) {
        DateTimeFormatter dateFormat = DateTimeFormatter.ofPattern("M/d/yyyy");
        LocalDate localDate;
    ...
    public static void save(ArrayList<Appointment> apts, PrintWriter output_file) {
