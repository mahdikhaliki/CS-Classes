...
(begin (define x '(1 2)) (define y x))
; expect y

y
; expect (1 2)

(begin 9 (begin (define y 3) 4 ))
; expect 4
...
(lambda (hello world) (print world))
; expect (lambda (hello world) (print world))

(lambda (x) (define x 3))
; expect (lambda (x) (define x 3))
...
fn
; expect (lambda (x) (+ (* x x) x 1))

(define (Ucb bear) ('Go_Bears))
; expect ucb

ucb
; expect (lambda (bear) ((quote go_bears))) 



;;; Problem 11 AND 12 Tests

(define a_procedure (lambda (a b) (+ a b)))
; expect a_procedure
...
(define (greater_than x y) (cond ((x > y) #t) #f))
; expect greater_than

greater_than
; expect (lambda (x y) (cond ((x > y) #t) #f))
...
(cond ((= (car '(1 2 3)) (car '(3 4 5))) 'test1) ((= (car '(6 7 8)) (car '(6 7 8))) 'test2))
; expect test2
...
(let ((a 20) (y (* a a))) (list a y))
; expect (20 100)

(print a)
; expect 10

(let ((b a) (a b)) (list a b))
; expect (5 10)
...
(define square (mu () (* x x)))
; expect square

(define square_of (lambda (y) (define x y) (square)))
; expect square_of
...
(define square_of (lambda (x) (square)))
; expect square_of
