    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if isinstance(insect, QueenAnt):
                if self.ant.is_container == False:
                    if QueenAnt.queen_in_place is not insect:
                        self.ant = None
                    return None
                else:
                    if self.ant.contained_ant is not None:
                        if QueenAnt.queen_in_place is not self.ant.contained_ant:
...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        if self.direction == 'forward':
            ...
            if self.place.entrance is not None:
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        return (self.is_container) and (self.contained_ant is None) and (not other.is_container)
        # END Problem 9
    ...
    def add_insect(self, insect):
        ...
        if not insect.is_watersafe:
            if insect.is_ant:
                ...
                self.bees[0].reduce_armor(self.bees[0].armor)
        # END Problem 11
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        "*** YOUR CODE HERE ***"
        self.armor = armor
        if QueenAnt.queen_in_place is None:
            QueenAnt.queen_in_place = self
        # END Problem 13
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if self.queen_in_place is self:
            ...
            while current_place is not None:
                if (current_place.ant is not None):
                    if (current_place.ant.is_container) and \
                       (current_place.ant.contained_ant is not None) and \
                       (current_place.ant.contained_ant not in self.doubled_damage_ants):
                        self.double_damage(current_place.ant.contained_ant)
                    if current_place.ant not in self.doubled_damage_ants:
                        self.double_damage(current_place.ant)
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 13
        "*** YOUR CODE HERE ***"
        if QueenAnt.queen_in_place is self:
            self.armor -= amount
            if self.armor <= 0:
                bees_win()
        else:
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    "*** YOUR CODE HERE ***"
    og_bee_action = bee.action

    def apply_effect_helper(colony):
        nonlocal duration
        if duration > 0:
            effect(og_bee_action, bee)(colony)
            bee.action = apply_effect_helper
            duration -= 1
        else:
            bee.action, bee.direction = og_bee_action, 'forward'
            bee.action(colony)
