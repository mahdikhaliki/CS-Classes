...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    i, total, roll, pig_out = 0, 0, 0, False
    while i < num_rolls:
        i, roll = i + 1, dice()
        if roll == 1:
            pig_out = True
...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    return ((score % 10) * ((score // 10) % 10)) % 10 + 1
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # END PROBLEM 6
    return score0, score1   # Problem 5
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if player_score - previous_score > previous_high:
            print(player_score - previous_score,"point(s)! That's the biggest "
                  "gain yet for Player", who)
            return announce_highest(who, player_score - previous_score, player_score)
        else:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    i, largest, num_rolls = 0, 0, 0
    averaged_roll_dice = make_averaged(roll_dice, num_samples)
    while i < 10:
        i += 1
        current = averaged_roll_dice(i, dice)
        if  current > largest:
            largest, num_rolls = current, i
    return num_rolls
    # END PROBLEM 9
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    score_plus_free_bacon = score + free_bacon(opponent_score)
    if (opponent_score > score_plus_free_bacon and
        is_swap(score_plus_free_bacon, opponent_score)):
        return 0
