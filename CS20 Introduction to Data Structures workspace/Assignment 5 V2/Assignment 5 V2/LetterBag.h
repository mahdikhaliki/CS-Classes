...
public:
    ...
    LetterBag(const string & v);  // initialize using letters in v, omitting non letters
    ...
    string toString() const; // return a vector with the letters in this object, in sorted order.
